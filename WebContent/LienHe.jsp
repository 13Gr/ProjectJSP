...
<div class="container-fluid">
  <div class="row">
    ...
    <li><a href="share-tailieu.jsp">Share Tài Liệu</a></li>
		...
		<form>
			<fieldset>
				<legend align="center"><h1 style="color:red;">Mọi thông tin chi tiết xin vui lòng liên hệ</h1></legend>
				<h3><b>Tô Ngọc Anh</b></h3>
				<h3><b>Phạm Công Dân</b></h3>
				<h3><b>Nguyễn Ngọc Cảnh</b></h3>
				<h3><b>Nguyễn Đình Phúc</b></h3>
			</fieldset>
		</form>
		</div>
